...
import otros.*; // Importa al package "otros"
...
public class Principal {
     public static void main(String args[]){
        ...
        Directivo directivo1 = new Directivo("Jhon","Smith"); // Usa el constructor de Empleado con "Super"
        directivo1.setPuesto("CEO");
        directivo1.setSalarioBase(50_000);
       
        
        Gerente gerente1 = new Gerente("Juan","Perez"); // Usa el constructor de Empleado con "Super"
        gerente1.setPuesto("G de Ventas");
        gerente1.setNumSubordinados(5);
        
        Gerente gerente2 = new Gerente("Luis","garcia"); // Usa el constructor de Empleado con "Super"
        gerente2.setPuesto("G de Ingenieria");
        gerente2.setNumSubordinados(3);
               
        
        Operativo operativo1 = new Operativo("Luis","gomez"); // Usa el constructor de Empleado con "Super"
        operativo1.setJornadaLaboral(10);
        operativo1.setTurno("matutino");
        
              
        Operativo operativo2 = new Operativo("david","faitelson"); // Usa el constructor de Empleado con "Super"
